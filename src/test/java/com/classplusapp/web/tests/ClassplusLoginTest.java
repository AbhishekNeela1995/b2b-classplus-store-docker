...
public class ClassplusLoginTest extends BaseClassplusAutomationTest {
	...
	@BeforeClass
	@Parameters({ "browser" })
	public void initClassplusSiteLogin(@Optional("Chrome")String browser) throws Exception {
	...
	public void testLoginSiteUI(String orgCode) {
		logger.info("Startitng of LoginToSite method");
		try {
			this.siteLogin(orgCode, tutorMobileNumber, emailAddress, this.driver);

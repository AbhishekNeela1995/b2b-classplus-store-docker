...
public class StudentPhysicalShipmentPage extends BaseClassplusAutomationPage {
	...
	@FindBy(xpath = "//div[@class='Shipment__Modal__Body__AddressList--Item--Actions--Edit']")
	...
	@FindBy(xpath = "//div[@class='Dropdown_ChatDropdown__34tKP ChatDropdown Shipment__Modal__Body__Input--Field--State']/../input")
	...
	@FindBy(xpath = "//span[@class='Shipment__Buy__AddressSection--Change']")
	private WebElement btnChangeAddress;

	@FindBy(xpath = "//div[@class='Shipment__Modal__Body__AddressList--Item--Actions--Delete']")
	private WebElement btnDeleteAddress;

	@FindBy(xpath = "//div[@class='Shipment__DeleteModal__Body--Delete']")
	private WebElement btnConfirmDeleteAddress;

	@FindBy(xpath = "//div[@class='Shipment__Modal__Body__AddressList--AddNew']")
	private WebElement addNewAddress;

	@FindBy(xpath = "//label[@class='Shipment__Modal__Bottom--SetDefault']/../input")
	private WebElement setasDefault;

	@FindBy(xpath = "//div[@class='Shipment__Buy__AddressSection--SelectedAddress']")
	...
	public StudentPhysicalShipmentPage(WebDriver driver) {
		super(driver);
	...
	public void btnDownloadInvoice() {
		...
		try {
			this.clickOnWebElement(btnDownloadInvoice);
		} catch (Exception e) {
	...
	public boolean isSelectedAddressData() {
		logger.info("starting of isSelectedAddressData method");
		try {
			inputFullName.isDisplayed();
			return true;
		} catch (Exception e) {
			return false;
		}
